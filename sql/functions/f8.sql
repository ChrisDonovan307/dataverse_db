...
-- test function
select totalSize('dataset', null) from dual;
select totalSize(null, 'test') from dual;
select totalSize() from dual;
select totalSize('fjewilff', 'hweoufwehf') from dual;
select totalSize('dataset', 'hweoufwehf') from dual;
select totalSize('dataset', 'doi:10.7281/T1/0EYOMQ') from dual;
select totalSize('collection', '99999') from dual;
select totalSize('collection', '1') from dual;
select totalSize('collection', '2') from dual;
select totalSize('dataverse', '1') from dual;
select totalSize('dataverse', '2') from dual;

-- reset
drop function totalSize;
