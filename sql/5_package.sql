...
create or replace package dataverse as
	...
	-- could not get custom type to behave within this Package
	-- type and dependent routines have been moved into
	-- extra_routines.sql
...
create or replace package body dataverse as
	...
	-- p5. ---------------------------------------------------------
	-- cleanKeywords has been moved to extra_routines.sql to resolve
